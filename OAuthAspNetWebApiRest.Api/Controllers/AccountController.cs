...
using OAuthAspNetWebApiRest.Api.Results;
...
namespace OAuthAspNetWebApiRest.Api.Controllers
{
    ...
    public class AccountController : BaseAuthApiController
    {
        ...
        {
            IdentityUser user = await _userService.FindByIdAsync(User.Identity.GetUserId());
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            IdentityResult result = await _userService.ChangePasswordAsync(User.Identity.GetUserId(), model.OldPassword,
                model.NewPassword);
        ...
        public async Task<IHttpActionResult> SetPassword(SetPasswordBindingModel model)
        {
            ...
            IdentityResult result = await _userService.AddPasswordAsync(User.Identity.GetUserId(), model.NewPassword);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            IdentityResult result = await _userService.AddLoginAsync(User.Identity.GetUserId(),
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            {
                result = await _userService.RemovePasswordAsync(User.Identity.GetUserId());
            }
            else
            {
                result = await _userService.RemoveLoginAsync(User.Identity.GetUserId(),
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            User user = await _userService.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
